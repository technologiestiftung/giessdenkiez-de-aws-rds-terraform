...
output "db_connection_string" {
  description = "The database url postgresql://[user[:password]@][netloc][:port][/dbname][?param1=value1&...]"
  value       = "postgresql://${module.db.db_instance_username}:${module.db.db_instance_password}@${module.db.db_instance_password}:5432/${module.db.db_instance_name}"
