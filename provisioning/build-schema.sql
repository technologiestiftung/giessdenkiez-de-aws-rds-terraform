...
CREATE TABLE public.trees_extention (
    id_ text NOT NULL,
    "STANDORTNR" text,
    "KENNZEICH" text,
    "NAMENR" text
...
CREATE TABLE public.trees_temp (
    id text NOT NULL,
    lat text,
    lng text,
    artdtsch text,
...
CREATE MATERIALIZED VIEW public.trees_mv2 AS
 SELECT trees_mv.id,
    trees_mv.lat,
    trees_mv.lng,
    trees_mv.artdtsch,
...
CREATE TABLE public.trees_watered_batch (
    tree_id text,
    "time" text,
    uuid text,
    amount text,
...
ALTER TABLE ONLY public.radolan_data ALTER COLUMN id SET DEFAULT nextval('public.radolan_data_id_seq'::regclass);
...
ALTER TABLE ONLY public.radolan_geometry ALTER COLUMN id SET DEFAULT nextval('public.radolan_geometry_id_seq'::regclass);
...
ALTER TABLE ONLY public.radolan_harvester ALTER COLUMN id SET DEFAULT nextval('public.radolan_harvester_id_seq'::regclass);
...
ALTER TABLE ONLY public.radolan_temp ALTER COLUMN id SET DEFAULT nextval('public.radolan_temp_id_seq'::regclass);
...
ALTER TABLE ONLY public.trees_adopted ALTER COLUMN id SET DEFAULT nextval('public.trees_adopted_id_seq'::regclass);
...
CREATE INDEX pflanzjahr_index ON public.trees USING btree (pflanzjahr);
...
CREATE INDEX pflanzjahr_temp_index ON public.trees_temp USING btree (pflanzjahr);
...
CREATE INDEX radolan_data_geom_id ON public.radolan_data USING btree (geom_id);
...
CREATE INDEX radolan_data_measured_at ON public.radolan_data USING btree (measured_at);
...
CREATE INDEX radolan_geometry_centroid ON public.radolan_geometry USING gist (centroid);
...
CREATE INDEX radolan_geometry_geometry ON public.radolan_geometry USING gist (geometry);
...
CREATE INDEX radolan_temp_geometry ON public.radolan_temp USING gist (geometry);
...
CREATE INDEX trees_adopted_tree_id ON public.trees_adopted USING btree (tree_id);
...
CREATE INDEX trees_geom ON public.trees USING gist (geom);
...
CREATE INDEX trees_id_idx ON public.trees USING btree (id);
...
CREATE INDEX trees_temp_geom ON public.trees_temp USING gist (geom);
...
CREATE INDEX trees_temp_id_idx ON public.trees_temp USING btree (id);
...
CREATE UNIQUE INDEX trees_temp_temp_pkey ON public.trees_temp USING btree (id);
...
CREATE INDEX trees_watered_timestamp ON public.trees_watered USING btree ("timestamp");
...
CREATE INDEX trees_watered_tree_id ON public.trees_watered USING btree (tree_id);
...
CREATE INDEX trees_watered_uuid ON public.trees_watered USING btree (uuid);
...
REVOKE ALL ON SCHEMA public FROM fangorn;
...
REVOKE ALL ON TABLE tiger.geocode_settings FROM fangorn;
...
REVOKE ALL ON TABLE tiger.geocode_settings_default FROM fangorn;
...
REVOKE ALL ON TABLE tiger.loader_lookuptables FROM fangorn;
...
REVOKE ALL ON TABLE tiger.loader_platform FROM fangorn;
...
REVOKE ALL ON TABLE tiger.loader_variables FROM fangorn;
...
REVOKE ALL ON TABLE tiger.pagc_gaz FROM fangorn;
...
REVOKE ALL ON TABLE tiger.pagc_lex FROM fangorn;
...
REVOKE ALL ON TABLE tiger.pagc_rules FROM fangorn;
